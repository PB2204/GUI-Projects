...
def search_query():
        ...
        s = googlesearch.search(query, tld=".com", num=10, stop=1, pause=2)
        for j in s:
...
apps.bind("<Button-1>",lambda e: callback("https://www.google.co.in/intl/bn/about/products"))
...
i.place(x=670,y=50)
i.bind("<Button-1>",lambda e: callback("https://www.google.com/imghp?hl=en&tab=wi&ogbl"))

#signin button
signin = Button(root,text="sign in",font=('roboto',10,'bold'),bg="#4583EC",fg="white",cursor="hand2")
signin.place(x=730,y=50) 
signin.bind("<Button-1>",lambda e: callback("https://google.com"))
...
apps.bind("<Button-1>",lambda e: callback("https://google.com"))
